...
<youi:page>
	<youi:grid id="grid_propertyservicemanagerEntering" idKeys="enteringId" caption="可办理预约记录列表"  panel="false"
		...
		<youi:gridCol property="enteringStatus"  caption="可预约状态" convert="enteringStatus"  width="100"/>
		
		<youi:gridCol property="enteringTime"  caption="预约时间段" convert="enteringTime" width="150"/>
