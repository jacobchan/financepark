...
@Component("cms.commonCenter.NewsManager.nmIssuenews")
public class NewDataPageModel extends AbstractPageModel implements IPageModel{
	
	@Autowired
	private NmIssuetypeManager nmIssuetypeManager;

	  public ModelMap nmIssuenews(HttpServletRequest request, DataIn<NmIssuetype> dataIn)	  {
