...
<youi:page>
	...
	<youi:grid id="grid_purchasingmanagerCommodity" idKeys="commodityId,purchasingmanagerMerchant.merchantId" caption="商品信息列表"  panel="false"
		...
		<youi:fieldLayout labelWidths="120,120">
			...
			<youi:fieldTree simple="false" popup="true" tree="${genreTree}" property="genreId" caption="类别" onlyLeaf="true"/>
		...
		<youi:gridCol property="purchasingmanagerMerchant.merchantName"  caption="商户名称" align="center" width="12%"/>
		...
		<youi:gridCol property="commodityDescribe"  caption="描述" align="center" width="19%"/>
