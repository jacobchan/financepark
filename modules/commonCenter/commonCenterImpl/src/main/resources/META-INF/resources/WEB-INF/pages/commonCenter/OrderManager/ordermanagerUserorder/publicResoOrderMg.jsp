...
<youi:page>
	<youi:grid id="grid_publicResoOrderMg" idKeys="userorderId" caption="公共资源订单列表"  panel="false"
				src="esb/web/ordermanagerUserorderManager/getPagerPublicResoOrders.json" dataFormId="form_publicResoOrderMg"
		...
		<youi:fieldLayout labelWidths="120,120">
			...
			<youi:fieldSelect property="genreId.genreId"  caption="订单类型" code="genreId" show="genreName"
				src="esb/web/purchasingmanagerGenreManager/getPublicResoOrderTypes.json"/>
		</youi:fieldLayout>
	...
	<!-- form-用户订单表编辑 -->
	<youi:form dialog="true" caption="公共资源订单编辑" id="form_publicResoOrderMg" 
		action="esb/web/ordermanagerUserorderManager/saveOrder.json">
