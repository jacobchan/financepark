...
<youi:page>
	<youi:grid id="grid_nmIssuetempalate" idKeys="issueTempalateId" caption="发布模板列表"  panel="false"
		...
		<youi:fieldLayout columns="2" labelWidths="100,100">
			<youi:fieldText property="issueTempalateCaption"  caption="发布模板名称" operator="LIKE"/>
		</youi:fieldLayout>

		<youi:gridCol property="issueTempalateCaption"  caption="发布模板名称" width="15%" align="center"/>
		<youi:gridCol property="issueTempalateContent"  caption="发布模板内容" width="25%" align="center"/>
		<youi:gridCol property="nmIssuetype.issueTypeCaption"  caption="发布类型" width="15%" align="center"/>
		<youi:gridCol property="issueTempalateTo"  caption="发送到" width="15%" align="center"/>
		<youi:gridCol property="issueSendstatus"  caption="使用状态" width="15%" align="center"/>
		<%-- <youi:gridCol property="issueTempalateSrc"  caption="模板路径" width="15%"/> --%>
	...
	<youi:form dialog="true" caption="发布模板" id="form_nmIssuetempalate" action="esb/web/nmIssuetempalateManager/saveNmIssuetempalate.json">
		<youi:fieldLayout prefix="record" columns="2" labelWidths="100,100">
			...
			<youi:fieldText property="issueTempalateCaption"  caption="发布模板名称" notNull="true"/>
			<youi:fieldSelect property="nmIssuetype.issueTypeId"  caption="发布类型" notNull="true"
