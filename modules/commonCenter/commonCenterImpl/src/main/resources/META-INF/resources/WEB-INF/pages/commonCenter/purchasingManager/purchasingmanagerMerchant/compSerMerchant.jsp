...
<youi:page>
	...
	<youi:grid id="grid_compSerMerchant" idKeys="merchantId,merchantUrl,merchantAbout" caption="商户信息表列表"  panel="false"
				src="esb/web/purchasingmanagerMerchantManager/getPagerCompSerMerchants.json" dataFormId="form_compSerMerchant"
		...
		<youi:fieldLayout labelWidths="120,120">
			<youi:fieldSelect property="merchantType.genreId" src="esb/web/purchasingmanagerGenreManager/getCompSerOrderTypes.json" 
	...
	<!-- form-商户信息表编辑 -->
	<youi:form dialog="true" caption="商户信息表" id="form_compSerMerchant" 
