...
<youi:page>
	...
	<youi:grid id="grid_purchasingmanagerCommodity" idKeys="commodityId,purchasingmanagerMerchant.merchantId" caption="商品信息列表"  panel="false"
				src="esb/web/purchasingmanagerCommodityManager/getPagerMeetRoomCommoditys.json" dataFormId="form_purchasingmanagerCommodity"
	...
	<youi:form dialog="true" caption="商品信息" id="form_purchasingmanagerCommodity" 
		action="esb/web/purchasingmanagerCommodityManager/saveMeetRoomCommodity.json">
		<youi:fieldLayout prefix="record" labelWidths="120,120">
			...
			<youi:fieldSelect property="purchasingmanagerMerchant.merchantId" show="merchantName" code="merchantId" notNull="true" 
				src="esb/web/purchasingmanagerMerchantManager/getMeetRoomMerchants.json" caption="所属商户"/>
