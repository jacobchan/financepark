...
<youi:page i18n="i18n.security.messages">
	<youi:grid id="grid_purchasingmanagerGenreProperty" idKeys="genrePropertyId" caption="商品类属性列表"  panel="false"
		...
		<youi:fieldLayout>
			...
			<youi:fieldSelect property="category"  caption="所属分类" convert="category"/>
		</youi:fieldLayout>
		<youi:gridCol property="purchasingmanagerGenre.genreName"  caption="商品类别" align="center" width="25%"/>
		<youi:gridCol property="category"  caption="所属分类" align="center" width="25%" convert="category"/>
		<youi:gridCol property="genrePropertyDisplayName"  caption="显示名称" align="center" width="25%"/>
		<youi:gridCol property="genrePropertyFieldName"  caption="字段名称" align="center" width="25%"/>
	...
	<youi:form dialog="true" caption="商品类属性" id="form_purchasingmanagerGenreProperty" 
		...
		<youi:fieldLayout prefix="record">
			...
			<youi:fieldSelect property="category"  caption="所属分类" convert="category"  notNull="true"/>
