...
<youi:page>
	...
	<youi:grid id="grid_nmIssuenews" idKeys="policyId" caption="政策法规内容列表"  panel="false"
				src="esb/web/nmIssuenewsManager/getPagerNmIssuenewss.json?issueTypeCode=0103" dataFormId="form_nmIssuenews" 
		...
		<youi:fieldLayout columns="2" labelWidths="100,100">
			<youi:fieldText property="policyCaption"  caption="政策法规名称" operator="LIKE"/>
		...
		<youi:gridCol property="policyCaption"  caption="政策法规名称" width="100" align="center"/>
	...
	<!-- form-政策新闻内容编辑 -->
	<youi:form dialog="true" caption="政策法规内容" id="form_nmIssuenews" 
			action="esb/web/nmIssuenewsManager/saveNmIssuenewss.json?code=0103" width="1100">
