...
<youi:page>
	<youi:grid id="grid_bbmBuilding" idKeys="buildingId" caption="楼栋基础信息列表"  panel="false"
		...
		<youi:fieldLayout columns="2" labelWidths="100,100">
			...
			<youi:fieldText property="buildingCaption"  caption="楼宇说明" operator="LIKE"/>
		</youi:fieldLayout>
		<youi:gridCol property="buildingNo" caption="楼栋编号" width="10%" align="center"/>
		<youi:gridCol property="buildingCaption"  caption="楼宇说明" width="15%" align="center"/>
		<%-- <youi:gridCol property="bbmPark.parkName" caption="所属园区"></youi:gridCol> --%>
		<youi:gridCol property="parkName"  caption="所属园区" width="10%" align="center"/>
		<youi:gridCol property="buildingType"  caption="楼栋类别" width="10%" align="center"/>
		<youi:gridCol property="buildingUnitCount"  caption="楼宇单元数" width="10%" align="center"/>
		<youi:gridCol property="attributeFloorCount"  caption="楼宇层数" width="10%" align="center"/>
		<youi:gridCol property="company"  caption="入驻企业" width="30%"/>
	...
	<youi:form dialog="true" caption="楼栋基础信息" id="form_bbmBuilding" action="esb/web/bbmBuildingManager/saveBbmBuilding.json">
		<youi:fieldLayout prefix="record" columns="2" labelWidths="100,100">
			...
			<youi:fieldText property="company"  caption="入驻企业" column="2"/>
			<youi:fieldText property="buildingPhotoPath"  caption="楼栋照片路径" column="2"/>
		</youi:fieldLayout>
	</youi:form>
