...
public class UnifiedOrderReqData {
    ...
    /**
     * 统一下单请求数据协议
     * @param body 商品或支付单简要描述 String(128)
     ...
     * @param tradeType 取值如下：JSAPI，NATIVE，APP，详细说明见参数规定
     * 		  JSAPI--公众号支付、NATIVE--原生扫码支付、APP--app支付，统一下单接口trade_type的传参可参考这里
     * 		  MICROPAY--刷卡支付，刷卡支付有单独的支付接口，不调用统一下单接口
     * @param detail 商品名称明细列表 此字段最长可以放8000字符
     ...
     * @param timeExpire 订单失效时间，格式为yyyyMMddHHmmss，如2009年12月27日9点10分10秒表示为20091227091010。其他详见时间规则 
     * 					   注意：最短失效时间间隔必须大于5分钟
     * @param goodsTag 商品标记，代金券或立减优惠功能的参数，说明详见代金券或立减优惠
     * @param limitPay no_credit--指定不能使用信用卡支付
     */
    public UnifiedOrderReqData(String body,String outTradeNo,int totalFee,String spBillCreateIP,String tradeType,String openid,String productId,String detail, String attach,String deviceInfo,String timeStart,String timeExpire,String goodsTag,String limitPay){

        //公众号微信分配的公众账号ID（企业号corpid即为此appId）/ app支付:微信开放平台审核通过的应用APPID
        ...
        //商户系统内部的订单号,32个字符内可包含字母, 确保在商户系统唯一 必填
