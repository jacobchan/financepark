...
ZoomPic.prototype = 
{
	initialize : function (id)
	{
		...
		this.options = [
			...
			{width:285, height:120, top:90, left:150, zIndex:1},
			{width:325, height:180, top:60, left:75, zIndex:2},
			{width:365, height:240, top:30, left:0, zIndex:3},
...
window.onload=window.onresize= function ()
{
	...
	$(".banner-bg").css("height",h);
	$(".banner-bg .pa").click(function(){
		$("body,html").animate({
		    scrollTop: h
		  }, 600)
	})			
