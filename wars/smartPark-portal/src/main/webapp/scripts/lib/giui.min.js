					...
					if(typeof(record)==='object'){
						for(var prop in record){
							if(typeof(record[prop])=='object'){
								for(var subprop in record[prop]){
									if($.youi.stringUtils.notEmpty(record[prop][subprop])){
										str = str.replace(new RegExp("\\{" + prop+"."+subprop + "\\}", "g"), record[prop][subprop]);
									}
								}
							}else{
...
/***/ function(module, exports, __webpack_require__) {
	...
	//	var _log = $.youi.log;
		...
		$.widget("youi.select",$.youi.abstractWidget,$.extend({},{
			options:{
				bindResize:true
			},
