...
<youi:page>
	...
	<youi:grid id="grid_flow" idKeys="flowId" dataFormId="form_flow"  caption="流程列表" 
		...
		<youi:gridCol width="20%" property="flowCaption"  caption="流程描述"/>
		<youi:gridCol width="18%" property="flowName"  caption="流程定义"/>
		<youi:gridCol width="14%" property="status"  caption="部署状态"/>
		<youi:gridCol width="16%" property="deployTime"  caption="部署时间"/>
		<youi:gridCol width="16%" property="deployId"  caption="部署 "/>
		<youi:gridCol width="16%" property="version"  caption="版本号"/>
