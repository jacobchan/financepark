...
<%@ page language="java" pageEncoding="UTF-8"%>
 ...
 <youi:page>
	...
	<youi:grid id="grid_repairOrder" idKeys="processDefinitionId,id,processInstanceId" caption="维修工接单"  panel="false"
		...
		<youi:fieldLayout prefix="search" labelWidths="100,100">
			...
			<youi:fieldText property="params.status"  caption="状态" defaultValue="04"/>
		</youi:fieldLayout>
