...
<script type="text/javascript" src="<%=request.getContextPath()%>/scripts/lib/jquery-ui.min.js?1=1"></script>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/scripts/lib/laydate/laydate.js"></script>
