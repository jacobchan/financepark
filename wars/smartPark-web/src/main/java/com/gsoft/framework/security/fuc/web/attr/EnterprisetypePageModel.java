...
@Component("commonCenter.EnterpriceTypeManager.etypeEnterprisetype")
public class EnterprisetypePageModel extends AbstractPageModel implements
		IPageModel {
	@Autowired
	private EtypeEnterprisetypeManager etypeEnterprisetypeManager;

	public ModelMap etypeEnterprisetype(HttpServletRequest request,
