...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<script type="text/javascript">
	  $(function (){
		      var urlstr = location.href;//取当前浏览器的地址
		      var vv = urlstr.split("?")[0];//分割，取问号前面
  			  var urlstatus=false;
    	  	  ...
    	  	  if(vv == cenUrl+"member/memberCenter/propertyService/propertyManageBxDetail.html"){
  				urlstr = cenUrl+"member/memberCenter/propertyService/propertyManageBx.html";
    	  	  }
    	  	  if(vv == cenUrl+"member/memberCenter/propertyService/propertyManageCosDetail.html"){
   				urlstr = cenUrl+"member/memberCenter/propertyService/propertyManageCos.html";
     	  	  }
    	  	  if(vv == cenUrl+"member/memberCenter/propertyService/propertyManageFkDetail.html"){
    				urlstr = cenUrl+"member/memberCenter/propertyService/propertyManageFk.html";
      	  	  }
    	  	  if(vv == cenUrl+"member/memberCenter/propertyService/propertyManageOcDetail.html"){
   				urlstr = cenUrl+"member/memberCenter/propertyService/propertyManageOc.html";
     	  	  }
