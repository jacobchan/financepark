...
<%@ page language="java" pageEncoding="UTF-8"%>
 ...
 <youi:page>
	...
	<youi:subpage caption="受理" subpageId="process"
	...
	<youi:grid id="grid_repairOrder" idKeys="processDefinitionId,id,processInstanceId" caption="物业受理"  panel="false"
		...
		<youi:button name="process" icon="addRecord" active="1" caption="受理"/>
