...
<%@ page language="java" pageEncoding="UTF-8"%>
 ...
 <youi:page>
	...
	<youi:grid id="grid_repairOrder" idKeys="processDefinitionId,id,processInstanceId" caption="用户评价"  panel="false"
		...
		<youi:fieldLayout prefix="search" labelWidths="100,100">
			...
			<youi:fieldText property="params.status"  caption="状态" defaultValue="07"/>
		</youi:fieldLayout>
		...
		<youi:button name="process" icon="addRecord" active="1" caption="关闭" submitAction="workflow/run/completeTask.json?status='07'"/>
