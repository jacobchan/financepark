...
<youi:html title="订单详情">
	<head>
		...
		<script type="text/javascript" src="<%=request.getContextPath()%>/scripts/memberCenter/meetingRoomOrderDetails.js"></script>
	</head>
	<youi:body decorator="memcenter">
		<div class="w1000">
			<h3 class="per-h3">会议室订单详情
			...
			<div class="clearfix mt20">
				...
				<div class="fr f12">
					...
					<a href="javascript:;" class="pb-btn tc" style="width:120px;">申请退款</a>
				</div>
			</div>		
		</div>
	<!--***弹窗 start****************************************-->
