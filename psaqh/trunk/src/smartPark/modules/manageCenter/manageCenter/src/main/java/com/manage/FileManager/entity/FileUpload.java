 ...
 *
 */
package com.manage.FileManager.entity;
 ...
 */
@Entity
@Table(name = "sp_file_upload")
public class FileUpload implements Domain{
	

	/**
	 * 
	 */
	private static final long serialVersionUID = -4805376849715025215L;
