...
<youi:page>
	<youi:grid id="grid_purchasingmanagerGenreevaluate" idKeys="genreevaluateId" caption="商品分类评价信息表列表"  panel="false" add="NOT"
		...
		<youi:gridCol property="purGenre.genreName"  caption="商品类别" align="center" width="12%" />
		<youi:gridCol property="type" convert="evaluateType" caption="类型" align="center" width="12%" />
		<youi:gridCol property="content"  caption="内容" align="center" width="13%" />
