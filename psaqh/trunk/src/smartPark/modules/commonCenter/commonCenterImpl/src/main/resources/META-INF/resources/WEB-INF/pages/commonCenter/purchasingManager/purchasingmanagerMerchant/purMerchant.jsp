...
<youi:page>
	...
	<youi:grid id="grid_purMerchant" idKeys="merchantId,merchantUrl,merchantAbout" caption="商户信息表列表"  panel="false"
				src="esb/web/purchasingmanagerMerchantManager/getPagerPurMerchants.json" dataFormId="form_purMerchant"
	...
	<!-- form-商户信息表编辑 -->
	<youi:form dialog="true" caption="商户信息表" id="form_purMerchant" 
		action="esb/web/purchasingmanagerMerchantManager/savePurMerchant.json">
