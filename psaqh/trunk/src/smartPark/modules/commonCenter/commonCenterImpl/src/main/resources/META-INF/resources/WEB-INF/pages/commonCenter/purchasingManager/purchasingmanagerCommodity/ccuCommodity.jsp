...
<youi:page>
	...
	<!--**********************************子页面**********************************-->
	<youi:grid id="grid_ccuCommodity" idKeys="commodityId,purchasingmanagerMerchant.merchantId" caption="商品信息列表"  panel="false"
				src="esb/web/purchasingmanagerCommodityManager/getPagerCcuCommoditys.json" dataFormId="form_ccuCommodity"
	...
	<!-- form-商品信息编辑 -->
	<youi:form dialog="true" caption="商品信息" id="form_ccuCommodity" 
		action="esb/web/purchasingmanagerCommodityManager/saveCcuCommodity.json">
	...
	<youi:func name="func_grid_commodity_extend">
		var selectRecord = $elem('grid_ccuCommodity',pageId).grid('getSelectedRecord');
	...
	<youi:func name="func_grid_veiwCommodity">
		var selectRecord = $elem('grid_ccuCommodity',pageId).grid('getSelectedRecord');
		$elem('form_ccuCommodity_view',pageId).form("reset").form('fillRecord',selectRecord).form('open');
	</youi:func>
	<!--**********************************页面函数End**********************************-->
</youi:page>