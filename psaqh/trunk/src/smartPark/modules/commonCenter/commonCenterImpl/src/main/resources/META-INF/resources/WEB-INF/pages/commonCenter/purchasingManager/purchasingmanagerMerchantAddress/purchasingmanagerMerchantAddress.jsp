...
<youi:page>
	<youi:grid id="grid_purchasingmanagerMerchantAddress" idKeys="merchantAddressId" caption="商户地址库列表"  panel="false"
		...
		<youi:gridCol property="merchantAddressLinkman"  caption="联系人" align="center" width="12%"/>
		<youi:gridCol property="merchantAddressPhone"  caption="联系电话" align="center" width="14%"/>
		<youi:gridCol property="merchantAddressIsnotDefault" convert="ISNOT" align="center"  caption="是否默认" width="10%"/>
		<youi:gridCol property="merchantAddressAddress"  caption="地址" align="left" width="64%"/>
