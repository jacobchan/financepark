...
<youi:page>
	<youi:grid id="grid_purOrdermanager" idKeys="userorderId" caption="采购订单列表"  panel="false"
				src="esb/web/ordermanagerUserorderManager/getPagerOrdermanagerUserorders.json" dataFormId="form_purOrdermanager"
		...
		<youi:fieldLayout labelWidths="120,120">
			...
			<youi:fieldHidden property="ordermanagerOrdertype.ordertypeId"  caption="订单类型" defaultValue="01"/>
		</youi:fieldLayout>
	...
	<!-- form-用户订单表编辑 -->
	<youi:form dialog="true" caption="采购订单编辑" id="form_purOrdermanager" action="esb/web/ordermanagerUserorderManager/savePurOrdermanager.json">
