...
<youi:page>
	...
	<youi:grid id="grid_nmIssuenews" idKeys="policyId" caption="园区公告内容列表"  panel="false"
				src="esb/web/nmIssuenewsManager/getPagerNmIssuenewss.json?issueTypeCode=0102" dataFormId="form_nmIssuenews" 
		...
		<youi:fieldLayout columns="2" labelWidths="100,100">
			<youi:fieldText property="policyCaption"  caption="公告名称" operator="LIKE"/>
		...
		<youi:gridCol property="policyCaption"  caption="公告名称" width="100" align="center"/>
		<youi:gridCol property="nmIssuetempalate.issueTempalateCaption"  caption="模板名称" width="100" align="center"/>
		<youi:gridCol property="policyType.issueTypeCaption"  caption="类型" width="100" align="center"/>
	...
	<!-- form-政策新闻内容编辑 -->
	<youi:form dialog="true" caption="园区公告内容" id="form_nmIssuenews" 
			action="esb/web/nmIssuenewsManager/saveNmIssuenewss.json?code=0102" width="1100">
		<youi:fieldLayout prefix="record" columns="2" labelWidths="120,120" >
			...
			<youi:fieldText property="policyCaption"  caption="公告名称"  notNull="true"/>
			<youi:fieldSelect property="nmIssuetempalate.issueTempalateId" caption="发布模板" 
				src="esb/web/nmIssuetempalateManager/getNmIssuetempalates.json" code="issueTempalateId" show="issueTempalateCaption" />
			...
			<youi:fieldCustom column="2" custom="fieldCkeditor" customOptions="{}" property="policyContent"  caption="公告内容"/>
		</youi:fieldLayout>
	</youi:form>
