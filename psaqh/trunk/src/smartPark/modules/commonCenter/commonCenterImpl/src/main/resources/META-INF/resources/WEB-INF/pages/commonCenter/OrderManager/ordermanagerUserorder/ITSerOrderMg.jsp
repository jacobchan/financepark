...
<youi:page>
	<youi:grid id="grid_ITSerOrderMg" idKeys="userorderId" caption="IT服务订单列表"  panel="false"
				src="esb/web/ordermanagerUserorderManager/getPagerOrdermanagerUserorders.json" dataFormId="form_ITSerOrderMg"
		...
		<youi:fieldLayout labelWidths="120,120">
			...
			<youi:fieldHidden property="ordermanagerOrdertype.ordertypeId"  caption="订单类型" defaultValue="06"/>
		</youi:fieldLayout>
	...
	<!-- form-用户订单表编辑 -->
	<youi:form dialog="true" caption="IT服务订单编辑" id="form_ITSerOrderMg" action="esb/web/ordermanagerUserorderManager/saveITSerOrderMg.json">
